...
To follow an application centric cloud, its important to build a model to characterize the applications living in a cloud. The important characters are:
- Delivery pipeline
- Runtime platform
...
The following can be at the intersection of the characters in a cloud applications:
